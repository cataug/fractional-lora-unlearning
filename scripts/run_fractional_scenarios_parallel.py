...
SUMMARY_CSV = ROOT / "summary_fractional_scenarios_parallel.csv"
SUMMARY_JSON = ROOT / "summary_fractional_scenarios_parallel.json"
...
# A100-safe default.
# Try 512 if one process is used.
BATCH_SIZE = 192

NUM_WORKERS = 1

# Safe default for one A100.
# Increase to 3 or 4 only if nvidia-smi shows low utilization and enough memory.
MAX_PARALLEL_JOBS = 4

# For one A100:
GPU_IDS = [0]

# For multiple GPUs, example:
# GPU_IDS = [0, 1, 2, 3]
# MAX_PARALLEL_JOBS = 4
...
# ============================================================
# DATASET CONFIGS — SAME AS PREVIOUS EXPERIMENT
# ============================================================
...
# ============================================================
# MODEL CONFIGS — SAME TRANSFORMERS
# ============================================================
...
def train_one(
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        for x, y in train_loader:
            ...
            # Important: unscale before manual gradient modification.
...
def main() -> None:
    ...
    print("=" * 100)
    print("PARALLEL FRACTIONAL SCENARIOS EXPERIMENT")
    print("=" * 100)
