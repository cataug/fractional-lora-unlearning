...
RUN_DIR = ROOT / "runs_fractional_focused_final"

SUMMARY_CSV = ROOT / "summary_fractional_focused_final.csv"
SUMMARY_JSON = ROOT / "summary_fractional_focused_final.json"
...
# A100 40GB safe default.
# If stable and GPU memory is free, try 5.
MAX_PARALLEL_JOBS = 3
GPU_IDS = [0]
...
SCENARIO_CONFIGS = [
    ...
    # --------------------------------------------------------
    # Best previous family: delayed head mix around lambda=0.01
    # --------------------------------------------------------
    adamw_cfg("delayed_head_mix_a08_lam005_warm3", "mix", "head", 0.80, 0.90, 0.005, 4),
    adamw_cfg("delayed_head_mix_a08_lam010_warm3", "mix", "head", 0.80, 0.90, 0.010, 4),
    adamw_cfg("delayed_head_mix_a08_lam015_warm3", "mix", "head", 0.80, 0.90, 0.015, 4),
    adamw_cfg("delayed_head_mix_a08_lam020_warm3", "mix", "head", 0.80, 0.90, 0.020, 4),

    # --------------------------------------------------------
    # Embeddings weak mix around lambda=0.005..0.015
    # --------------------------------------------------------
    adamw_cfg("emb_mix_a08_lam0025", "mix", "embeddings", 0.80, 0.90, 0.0025, 1),
    adamw_cfg("emb_mix_a08_lam005", "mix", "embeddings", 0.80, 0.90, 0.005, 1),
    adamw_cfg("emb_mix_a08_lam010", "mix", "embeddings", 0.80, 0.90, 0.010, 1),
    adamw_cfg("emb_mix_a08_lam015", "mix", "embeddings", 0.80, 0.90, 0.015, 1),

    # --------------------------------------------------------
    # Delayed embeddings mix
    # --------------------------------------------------------
    adamw_cfg("delayed_emb_mix_a08_lam005_warm3", "mix", "embeddings", 0.80, 0.90, 0.005, 4),
    adamw_cfg("delayed_emb_mix_a08_lam010_warm3", "mix", "embeddings", 0.80, 0.90, 0.010, 4),
    adamw_cfg("delayed_emb_mix_a08_lam015_warm3", "mix", "embeddings", 0.80, 0.90, 0.015, 4),
    adamw_cfg("delayed_emb_mix_a08_lam025_warm3", "mix", "embeddings", 0.80, 0.90, 0.025, 4),

    # --------------------------------------------------------
    # All-parameter weak mix around previous useful region
    # --------------------------------------------------------
    adamw_cfg("all_mix_a08_lam015", "mix", "all", 0.80, 0.90, 0.015, 1),
    adamw_cfg("all_mix_a08_lam020", "mix", "all", 0.80, 0.90, 0.020, 1),
    adamw_cfg("all_mix_a08_lam025", "mix", "all", 0.80, 0.90, 0.025, 1),
    adamw_cfg("all_mix_a08_lam030", "mix", "all", 0.80, 0.90, 0.030, 1),

    # --------------------------------------------------------
    # Embeddings replace alpha sweep around previous a07 signal
    # --------------------------------------------------------
    adamw_cfg("emb_replace_a060", "replace", "embeddings", 0.60, 0.90, 1.0, 1),
    adamw_cfg("emb_replace_a065", "replace", "embeddings", 0.65, 0.90, 1.0, 1),
    adamw_cfg("emb_replace_a070", "replace", "embeddings", 0.70, 0.90, 1.0, 1),
    adamw_cfg("emb_replace_a075", "replace", "embeddings", 0.75, 0.90, 1.0, 1),
]
...
def main() -> None:
    ...
    print("=" * 100)
    print("PARALLEL FRACTIONAL FOCUSED FINAL EXPERIMENT")
    print("=" * 100)
